...
export class ConfigurationDuProjet implements OnInit {
  ...
  updateValidation(): void {
    this.isFormValid = !!this.projectData.githubLink &&
                      !!this.projectData.projectLevel &&
                      !!this.projectData.deadline &&
                      !!this.projectData.fileName;
  }
